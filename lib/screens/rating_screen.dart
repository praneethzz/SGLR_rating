...
class _RatingScreenState extends State<RatingScreen> {
  ...
  Color get _scoreColor => _pct >= 85 ? Colors.green.shade700
      : _pct >= 65 ? Colors.amber.shade700 : Colors.red.shade700;
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Card(child: Padding(
            ...
            child: Column(children: [
              Text(widget.resort.name, style: const TextStyle(
                fontSize: 18, fontWeight: FontWeight.bold,
                color: Color(0xFF1B3A6B))),
              Text(widget.resort.area,
                style: TextStyle(color: Colors.grey.shade600)),
              const SizedBox(height: 20),
              Text('${widget.totalMarks}', style: TextStyle(
                fontSize: 64, fontWeight: FontWeight.bold,
                color: _scoreColor, height: 1)),
              Text('out of ${widget.maxMarks}',
                style: TextStyle(color: Colors.grey.shade500)),
              const SizedBox(height: 8),
              Text('${_pct.toStringAsFixed(1)}% — $_grade',
                style: TextStyle(fontSize: 16, color: _scoreColor,
              ...
              Text('$_stars / 5 stars (auto-calculated)',
          ...
          // Breakdown
          const Text('Score Breakdown', style: TextStyle(
          ...
          // Notes
          const Text('Officer Notes (optional)', style: TextStyle(
            fontSize: 15, fontWeight: FontWeight.bold,
            color: Color(0xFF1B3A6B))),
          const SizedBox(height: 8),
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Add any observations, violations, or follow-up notes...',
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          Text('$scored / $max', style: const TextStyle(
        ...
        ClipRRect(
          ...
          child: LinearProgressIndicator(
            ...
            valueColor: AlwaysStoppedAnimation<Color>(
              pct >= 0.8 ? Colors.green
              : pct >= 0.5 ? Colors.amber : Colors.red),
          ),
        ),
      ]),
    );
